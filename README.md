...
Предназначен для работы с данными товаров,добавленных в корзину.\
...
- set price - сеттер принимает параметр типа number или null и устанавливает цену товара. В зависимости от параметра (number или null) устанавливает текст для отображения ("кол-во синапсов" или "Бесценно"), а так же переключает состояние кнопки "Оформить";
